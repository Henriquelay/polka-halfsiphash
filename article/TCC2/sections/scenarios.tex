...
\begin{figure}[h]
    ...
    \newcommand{\newtopoitemanchors}[2]{%
        \node[core, right=2pt] (S#1) at (#2.east)   {$s_{#1}$};
    ...
    \begin{minipage}{0.49\linewidth}
        ...
        \begin{tikzpicture}[outer sep=auto]
            ...
            \node[core, right=2pt] at (S\theprevitem.east) (Sadd) {$s_{add}$};
            \newtopoitemanchors{6}{Sadd}
            \draw (S5) -- (Sadd) -- (S6);
            \stepcounter{previtem}

            \foreach \x in {\number\numexpr\splitpoint+1\relax, ..., \nswitches} {
                \newtopoitem{\x}{\arabic{previtem}}
                \ifnum \theprevitem < 11
                    \draw (S\x) to (S\theprevitem);
                \fi
        ...
        \end{tikzpicture}
        \caption{Addition scenario topology}
    ...
    \begin{minipage}{0.49\linewidth}
        ...
        \end{tikzpicture}
        \caption{Skipping scenario topology}
    ...
    \begin{minipage}{0.49\linewidth}
        ...
        \begin{tikzpicture}[outer sep=auto]
            ...
            \node[core, right=2pt] at (S\theprevitem.east) (Sdet) {$s_{det}$};
            \newtopoitemanchors{7}{Sdet}
            \draw (S5) -- (Sdet) -- (S7);
            \stepcounter{previtem}
            \stepcounter{previtem}
        ...
        \end{tikzpicture}
        \caption{Detour scenario topology}
    ...
    \begin{minipage}{0.49\linewidth}
        ...
        \begin{tikzpicture}[outer sep=auto]
            ...
            \draw (H11) to (E1);                
        \end{tikzpicture}
        \caption{Out of order scenario topology}
        \label{topology:outoforder}
    \end{minipage}

    \caption{Topologies for the different scenarios}
